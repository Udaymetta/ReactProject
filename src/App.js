...
import {TechDescription} from "./components/TechButtons.jsx";
...
//   return(
//     <article className='imgtitle-container'>
//       <img className='fram-image' src = {url} alt='logo'/>
//       <h3 className='fram-title'>{title}</h3>
